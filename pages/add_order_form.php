...
$origin_options = "";
$sql_origin = "SELECT id, CONCAT_WS(', ', moo, mooban, tambon, amphoe, province) AS full_address FROM origin ORDER BY province, amphoe, tambon LIMIT 500";
...
<body>
    <div class="container">
        ...
        <form id="addOrderForm">
            ...
            <div id="bill-details-container" class="mt-2 mb-3 p-3 border rounded bg-light" style="display: none;">
                <h6>ข้อมูลจากบิล</h6>
    ...
    <!-- แก้ไข: เพิ่ม version query string เพื่อบังคับให้โหลดไฟล์ใหม่ -->
            ...
            $('#cssale_docno').on('change', function() {
                ...
                if (selectedDocNo) {
                    ...
                    $.ajax({
                        ...
                        error: function() {
                            $('#display-custname').text('เกิดข้อผิดพลาดในการโหลด');
                            $('#display-shipaddr').text('เกิดข้อผิดพลาดในการโหลด');
                        }
                    });
                } else {
